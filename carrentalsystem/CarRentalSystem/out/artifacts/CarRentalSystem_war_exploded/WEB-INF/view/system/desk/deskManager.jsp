...
<!--查看弹出层开始-->
<div id="desk_showNoticeDiv" style="display: none;padding: 10px">
...
<script type="text/javascript">
    ...
    layui.use(['form','element','layer','jquery'],function(){
        ...
        //最新文章列表
        $.get("${ctx}/notice/loadAllNotice?page=1&limit=10",function(data){
            var hotNewsHtml = '';
            for(var i=0;i<5;i++){
                hotNewsHtml += '<tr ondblclick="viewNotice('+data.data[i].id+')">'
    ...
    function viewNotice(id) {
        $.post("${ctx}/notice/loadNoticeById",{id:id},function (data) {
            layer.open({
                type: 1,
                title:'查看公告',
                content: $('#desk_showNoticeDiv'),
                area:['600px','400px'],
                success: function () {
