...
public class RandomUtils {
	...
	private static SimpleDateFormat sdf3=new SimpleDateFormat("yyyy_MMddHHmmss_SSS");
    ...
    public static String createCarRentId(String p) {
		return p+"_"+sdf3.format(new Date())+"_"+ (random.nextInt(90000)+10000);
    }
}
